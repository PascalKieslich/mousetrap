...
#'   measures the dissimilarity per point and then sums the results. If
#'   \code{FALSE}, \code{mt_distmat}  measures dissimilarity once, treating the
#'   various points as separate dimensions. This is only relevant if
